...
class Baseline(nn.Module):
    ...
    def losses(self, outputs,gt_labels,outputs_teacher,gt_labels_teacher):
        ...
        loss_dict['loss_selfdis']=loss_kd(cls_score_real,pids_distill,newscore.detach())*5
        loss_dict['loss_trisal']=TripletLoss(self._cfg)(features_new, gt_labels)+CrossEntropyLoss(self._cfg)(newscore, gt_labels)*0.6
